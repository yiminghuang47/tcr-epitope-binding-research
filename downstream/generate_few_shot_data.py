...
train_df_orig = pd.read_csv(f"tchard-data/filtered_data_RN/train-{SPLIT}.csv")
test_df_orig = pd.read_csv(f"tchard-data/filtered_data_RN/test-{SPLIT}.csv")
train_df_encoded_orig = pd.read_csv(f"encoded_train_RN_{SPLIT}.csv")
test_df_encoded_orig = pd.read_csv(f"encoded_test_RN_{SPLIT}.csv")
...
train_df_encoded_new.to_csv(f"RN_few_shot_data/50_percent/train-{SPLIT}.csv",index=False)

test_df_encoded_new.to_csv(f"RN_few_shot_data/50_percent/test-{SPLIT}.csv",index=False)
