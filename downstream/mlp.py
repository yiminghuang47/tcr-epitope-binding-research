...
train_df = pd.read_csv(f"RN_few_shot_data/50_percent/train-{args.dataset}.csv")
test_df = pd.read_csv(f"RN_few_shot_data/50_percent/test-{args.dataset}.csv")
...
input_shape = (3072,)  # Input shape for each sample in X_train
