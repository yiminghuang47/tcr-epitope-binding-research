...
scaler = TCRDataset(df_train.copy(), torch.device(
    ...
    "cpu"), cdr3b_col='CDR3b', cdr3a_col='CDR3a', gt_col='binder').scaler



ds_test = TCRDataset(df_test, torch.device(

    "cpu"), cdr3b_col='CDR3b', cdr3a_col='CDR3a', gt_col='binder', scaler=scaler)
...
ds_train = TCRDataset(df_train, device, cdr3b_col='CDR3b',
                      ...
                      cdr3a_col='CDR3a', gt_col='binder', scaler=scaler)
...
pred = model.classify(
    ...
    pep=ds_test.pep, cdr3b=ds_test.cdr3b, cdr3a=ds_test.cdr3a)
